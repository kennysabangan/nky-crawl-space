...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    await resend.emails.send({
      from: `NKY Crawl Space Pros <lead@scalesolving.com>`,
      to: ['hello@scalesolving.com'],
      subject: `New Lead: ${fullName}` + (page_path && page_path !== '/' ? ` — ${page_path}` : ''),
      html: `<h2>New Lead from NKY Crawl Space Pros</h2>
...
<p>We received your quote request for <strong>NKY Crawl Space Pros</strong> and will get back to you shortly.</p>
<p>If you need immediate assistance, call us at <strong>(859) 900-8065</strong>.</p>
<p>— The NKY Crawl Space Pros Team</p>`,
    });
  } catch (error: any) {
